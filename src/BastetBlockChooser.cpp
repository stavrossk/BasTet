...
namespace Bastet
{
  ...
  boost::array<long,7> BastetBlockChooser::ComputeMainScores
  ...
  void Searcher::DFSVisit(Vertex v)
  {
		...
		if(_visited.insert(v).second==false)
  ...
  BestScoreVisitor
	  ::BestScoreVisitor(int bonusLines)
	  :_score(GameOverScore),
	  _bonusLines(bonusLines)
  {
